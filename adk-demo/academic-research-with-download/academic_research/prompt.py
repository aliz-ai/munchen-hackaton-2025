...
If the user provides a URL, attempt to download and read the PDF using the download_pdf tool. If the download fails notify the user and ask for another URL or a local file. Otherwise notify the user about the download location from downloaded_pdf and proceed with the analysis.
